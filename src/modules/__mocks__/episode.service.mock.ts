import { Episode } from '../episodes/domain/Episode.domain'
import { EspisodeTransformed } from '../../types/episode.type'

export const EpisodeServiceMock: Episode[] = [
  {
    artworkUrl30:
...
export const ResponseServiceTransformed: { results: EspisodeTransformed[]; resultCount: number } = {
  resultCount: 2,
  results: [
    {
      trackName: "60 Songs That Explain the '90s",
...
export const EpisodeServiceMockFalse: Episode[] = []
